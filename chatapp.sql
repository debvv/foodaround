...
--
-- Хост: 127.0.0.1
-- Время создания: Янв 12 2023 г., 20:27
...
(7, '2023-01-06 08:15:00', 'алекс', 767869359, 'лазанья', 'классическая лазания', 1, 'alex@mail.ru', 'chisinau bd. moscova 21', 'None, you can accept this task', 0),
...
(767869359, 'alex', 'smith', 'alex@mail.ru', '534b44a19bf18d20b71ecc4eb77c572f', '1673283924Screenshot_3.png', 'Active now', 'Consumer'),
...
(1527932594, 'root', 'root', 'root@mail.ru', '63a9f0ea7bb98050796b649e85481845', '1664863729wPvAvnMAmsk.jpg', 'Offline now', 'Admin');
...
--
ALTER TABLE `orders`
  ADD CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`from_id`) REFERENCES `users` (`unique_id`),
  ADD CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`accepted`) REFERENCES `users` (`unique_id`);
COMMIT;
